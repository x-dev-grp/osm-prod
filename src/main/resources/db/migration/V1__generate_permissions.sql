...
CREATE OR REPLACE FUNCTION add_basic_permissions(
...
BEGIN
    ...
    VALUES 
        (gen_random_uuid(), 'CREATE', p_entity_name, p_module_value, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
CREATE OR REPLACE FUNCTION add_custom_permission(
    p_entity_name VARCHAR,
